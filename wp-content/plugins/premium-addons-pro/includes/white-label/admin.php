                ...
                <div class="pa-row">
                    ...
                    <div class="pa-wht-lbl-settings-wrap">
                        ...
                        <div class="pa-wht-lbl-group-wrap">
                            ...
                            <h4 class="premium-wht-lbl-desc pa-wht-lbl-title"><label><?php echo __('Plugin Description:', 'premium-addons-pro'); ?></label></h4>
                            <input name="premium-wht-lbl-desc-pro" id="premium-wht-lbl-desc-pro" type="text" placeholder="Premium Addons Plugin Includes 20 premium widgets for Elementor Page Builder" value="<?php echo esc_attr( $this->pa_wht_lbl_get_settings['premium-wht-lbl-desc-pro'] ); ?>">
